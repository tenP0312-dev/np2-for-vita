...
//	{"opt14BRD", INITYPE_BYTEARG,	np2cfg.snd14opt,		3},
	...
	{"VITA_FRAMESKIP", INITYPE_UINT8,		&vita_np2_frameskip,	0},
	{"VITA_PRESENT_SKIP", INITYPE_UINT8,	&vita_np2_frameskip,	0},
	{"VITA_DRAWSKIP_CORE", INITYPE_BOOL,	&vita_np2_core_drawskip,	0},
	...
	{"VITA_CPU_MULT", INITYPE_SINT32,		&vita_np2_cpu_mult,	0},
	{"VITA_DRAW_SKIP", INITYPE_UINT8,		&vita_np2_frameskip,	0},
	{"VITA_FORCE_NOWAIT", INITYPE_BOOL,	&vita_np2_force_nowait,	0},
	{"VITA_FORCE_SKIPLINE", INITYPE_BOOL,	&vita_np2_force_skipline,	0},
	{"VITA_FORCE_GDC", INITYPE_UINT8,		&vita_np2_force_gdc,	0},
	{"VITA_SOUND_MODE", INITYPE_UINT8,		&vita_np2_sound_mode,	0},
	{"VITA_SOUND_BOARD", INITYPE_HEX8,		&vita_np2_sound_board,	0},
	{"VITA_USE_FMGEN", INITYPE_UINT8,		&vita_np2_use_fmgen,	0},
	{"VITA_UPD72020", INITYPE_BOOL,		&np2cfg.uPD72020,	0},
	...
	{"psp_turbo", INITYPE_BOOL,		&np2oscfg.pspturbo,		0}, // PSP
	{"psp_scrn", INITYPE_UINT8,		&np2oscfg.pspscrn,		0},
	{"psp_mbutton", INITYPE_BOOL,		&np2oscfg.pspmbutton,		0},
};
