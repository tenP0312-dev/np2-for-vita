...
const UINT8	*ptr;
	...
	REGPUSH0(REAL_FLAGREG) // ����V30�Œ��낪����Ȃ�
	REGPUSH0(I286_CS)
	REGPUSH0(I286_IP)
...
#if 0 // VITA_NP2_PORT i286 trace: disabled - file open/write/close per 262K insns causes frame hitches
	{
		static UINT32 vita_i286_trace = 0;
		if ((vita_i286_trace++ & 0x3ffff) == 0) {
			char logbuf[128];
			OEMSPRINTF(logbuf, OEMTEXT("i286: cs=%04x ip=%04x op=%02x rem=%d pref=%u"), I286_CS, (UINT16)(I286_IP - 1), opcode, I286_REMCLOCK, I286_PREFIX);
			vita_np2_log(logbuf);
		}
	}
#endif
