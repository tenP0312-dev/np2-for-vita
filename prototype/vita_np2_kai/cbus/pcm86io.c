...
UINT32 vita_pcm86_in466_count = 0;
UINT32 vita_pcm86_in468_count = 0;
UINT32 vita_pcm86_out46c_count = 0;
REG8 vita_pcm86_last466 = 0;
REG8 vita_pcm86_last468 = 0;
REG8 vita_pcm86_last46c = 0;
#endif
...
//	pcm86.write = 1;
	...
	{
		UINT32 addClock = 0;
		if (pcm86.fifosize < 8192) {
			addClock = (20000 * pccore.multiple) - ((20000 * pccore.multiple) * pcm86.fifosize / 8192);
		}
		if ((pcm86.virbuf > pcm86.fifosize * 2) || (pcm86.virbuf >= PCM86_LOGICALBUF)) {
			addClock = 20000 * pccore.multiple;
		}
		pcm86.lastclockforwait = CPU_CLOCK + CPU_BASECLOCK - CPU_REMCLOCK + addClock;
	}
#else
	if (pcm86.virbuf < PCM86_LOGICALBUF) {
		pcm86.virbuf++;
...
#endif
#if defined(VITA_NP2_PORT)
    vita_pcm86_out46c_count++;
    vita_pcm86_last46c = val;
#endif
	(void)port;
}
...
#if defined(VITA_NP2_PORT)
    vita_pcm86_in466_count++;
    vita_pcm86_last466 = ret;
#endif
	(void)port;
...
#endif
#if defined(VITA_NP2_PORT)
    vita_pcm86_in468_count++;
    vita_pcm86_last468 = ret;
#endif
	(void)port;
//	TRACEOUT(("86pcm in %.4x %.2x", port, ret));
	return(ret);
